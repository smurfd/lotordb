...
static void table_writeperson(Person person, Data *datatmp, FILE *write_ptr) {
...
static bool table_bruteforcesearch(char fn[], Data *datatmp, Data *dataall, u64 *header, u64 nr) {
  Person person;
